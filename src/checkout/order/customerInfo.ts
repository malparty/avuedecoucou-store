...
export class CustomerInfo implements CustomerInfoParams {
  ...
  constructor(params: CustomerInfoParams) {
    ...
    this.shippingFirstName = params.shippingFirstName;
    this.shippingLastName = params.shippingLastName;
    ...
    this.invoiceFirstName = params.invoiceFirstName;
    this.invoiceLastName = params.invoiceLastName;
